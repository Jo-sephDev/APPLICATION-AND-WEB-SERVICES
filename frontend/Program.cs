...
using frontend;                              // El espacio de nombres raíz de nuestro proyecto
using System.Net.Http;                       // Proporciona clases para enviar y recibir mensajes HTTP
using frontend.Services;                                // Contiene tipos fundamentales y clases base que definen comúnmente usados en .NET
...
builder.Services.AddScoped(sp => new HttpClient { 
    BaseAddress = new Uri("http:http://localhost:5026/api/") 
});
